...
import DogsContainter from "../../components/DogsCointeiner/DogsContainer";
import {
    getDogs,
    filterbyOrigin,
    orderDogAlphabetic,
    ...
    return (
        <div>
            <div>
                ...
                <select onClick={handleFilterByTemperaments} value={selectedTemperaments} onChange={(e) => setSelectedTemperaments(Array.from(e.target.selectedOptions, (option) => option.value))}>
